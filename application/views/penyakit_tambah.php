		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Data Master <small>Tambah Data Penyakit</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-building"></i>Nama-nama Penyakit
								</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('Penyakit/add'); ?>" 
								class="form-horizontal" method="post" enctype="multipart/form-data">
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="nm_penyakit" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Nama Penyakit!"  class="form-control input-circle" placeholder="Nama Penyakit">
											</div>
										</div>
									</div>
									<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="penanganan" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Penanganan!"  class="form-control input-circle" placeholder="Penanganan">
											</div>
										</div>
									<div class="form-group">
											<label class="col-md-3 control-label">Penyebab</label>
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="penyebab" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Penyebab!"  class="form-control input-circle" placeholder="Penyebab">
											</div>
										</div>
									<div class="form-group">
											<label class="col-md-3 control-label">Gambar Penyakit</label>
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="file" name="gbr_penyakit" data-validetta="required,maxLength[100]"  data-vd-message-required="Gambar Penyakit!"  class="form-control input-circle" placeholder="Gambar Penyakit">
											</div>
										</div>	
									</div>
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												...
												<a href="<?php echo base_url('Penyakit'); ?>" class="btn btn-circle default">Batal</a>
											</div>
										</div>
									</div>
								</form>
