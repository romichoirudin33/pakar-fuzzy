					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('Gejala/add'); ?>" class="form-horizontal" method="post"
								enctype="multipart/form-data">
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="nm_gejala" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Nama Gejala!"  class="form-control input-circle" placeholder="Nama Gejala">
											</div>
										</div>
									</div>
									<div class="form-group">
											<label class="col-md-3 control-label">Gambar Gejala</label>
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="file" name="gmbr_gejala" data-validetta="required,maxLength[100]"  data-vd-message-required="Gambar gejala!"  class="form-control input-circle">
											</div>
										</div>
