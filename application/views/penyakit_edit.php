					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('Penyakit/edit'); ?>" class="form-horizontal" method="post">
								<?php foreach ($data as $key): ?>
									...
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="nm_penyakit" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Nama Penyakit!"  class="form-control input-circle" placeholder="Nama Penyakit" value="<?php echo $key->nm_penyakit; ?>">
											</div>
										</div>
									</div>
									<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="penanganan" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Penanganan!"  class="form-control input-circle" placeholder="Penanganan" value="<?php echo $key->penanganan; ?>">
											</div>
										</div>
									<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="penyebab" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Penyebab!" value="<?php echo $key->penyebab; ?>"  class="form-control input-circle" placeholder="Penyebab">
											</div>
										</div>								
