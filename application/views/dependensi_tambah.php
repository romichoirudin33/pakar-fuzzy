		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Data Master <small>Tambah Data Dependensi Penyakit</small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('dependensi/add'); ?>" 
								class="form-horizontal" method="post" enctype="multipart/form-data">
									<div class="form-body">
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<select name="penyakit_id" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Nama Penyakit!"  class="form-control input-circle">
													<option value="">Pilih ...</option>
													<?php foreach ($penyakit as $key) { ?>
														<option value="<?php echo $key->id; ?>"><?php echo $key->nm_penyakit; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
									...
									<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<select name="gejala_id" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Gejala Penyakit!"  class="form-control input-circle">
													<option value="">Pilih ...</option>
													<?php foreach ($gejala as $key) { ?>
														<option value="<?php echo $key->id; ?>"><?php echo $key->nm_gejala; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												...
												<a href="<?php echo base_url('dependensi'); ?>" class="btn btn-circle default">Batal</a>
											</div>
										</div>
									</div>
								</form>
