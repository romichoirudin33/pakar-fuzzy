					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('Pengguna/add'); ?>" class="form-horizontal" method="post">
									<div class="form-body">
									...
									<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<select name="jenis_kelamin" data-validetta="required,maxLength[100]"  data-vd-message-required="jenis kelamin!"  class="form-control input-circle">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="date" name="tanggal_lahir" data-validetta="required,maxLength[100]"  data-vd-message-required="Tanggal Lahir!"  class="form-control input-circle" placeholder=>
											</div>
										</div>
										<div class="form-group">
