			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>Data Master <small>Data Pengguna </small></h1>
					</div>
					<!-- END PAGE TITLE -->
				</div>
				<!-- END PAGE HEAD -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-building"></i>Data Lemari
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url('pengguna/add'); ?>" class="btn green">
							...
							<tr class="odd gradeX">
								...
								<td>
									<a href="<?php echo base_url('pengguna/edit')."/".$key->id; ?>" class="label label-lg label-success">
									<span class="fa fa-edit"> Edit 
									</span>
									</a>
									<a href="<?php echo base_url('pengguna/delete')."/".$key->id; ?>" class="label label-lg label-danger"onclick="return confirm('Hapus Data Ini ?')">
