		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Data Master <small>Tambah Pengguna/small></h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			<!-- END PAGE HEAD -->
					...
					<div class="portlet box blue-hoki">
						<div class="alert alert-danger display-hide">
							...
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-building"></i>Nama-nama Pengguna
								</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form id="exm" action="<?php echo base_url('Pengguna/edit'); ?>" class="form-horizontal" method="post">
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Nama Pengguna</label>
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="nm_pengguna" data-validetta="required,maxLength[100]"  data-vd-message-required="Isi Nama Gejala!"  class="form-control input-circle" placeholder="Nama Gejala">
											</div>
										</div>
									</div>
									<div class="form-group">
											<label class="col-md-3 control-label">jenis kelamin</label>
										x\	<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="jenis_kelamin" data-validetta="required,maxLength[100]"  data-vd-message-required="jenis kelamin!"  class="form-control input-circle" placeholder=>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="tanggal_lahir" data-validetta="required,maxLength[100]"  data-vd-message-required="Tanggal Lahir!"  class="form-control input-circle" placeholder=>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="username" data-validetta="required,maxLength[100]"  data-vd-message-required="Username!"  class="form-control input-circle" placeholder=>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div id="alert"></div>
												<input type="text" name="password" data-validetta="required,maxLength[100]"  data-vd-message-required="Password!"  class="form-control input-circle" placeholder=>
											</div>
										</div>
 									</div>
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												...
												<a href="<?php echo base_url('pengguna'); ?>" class="btn btn-circle default">Batal</a>
											</div>
										</div>
									</div>
								</form>
