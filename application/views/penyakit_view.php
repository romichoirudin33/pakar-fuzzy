				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-building"></i>Data Penyakit
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo base_url('Penyakit/add'); ?>" class="btn green">
												Tambah Penyakit Baru <i class="fa fa-plus"></i>
											</a>
										</div>
									</div>
							...
							<tr class="odd gradeX">
								...
								<td>
									<?php echo $key->nm_penyakit; ?>
								</td>
								<td>
									<?php echo $key->penyebab; ?>
								</td>
								<td>
									<?php echo $key->penanganan; ?>
								</td>
								<td>
									<img style="max-height: 100px" src="<?php echo base_url('asset/penyakit/'.$key->gbr_penyakit); ?>">
								</td>
								<td>
									<a href="<?php echo base_url('Penyakit/edit')."/".$key->id; ?>" class="label label-lg label-success">
									<span class="fa fa-edit"> Edit 
									</span>
									</a>
									<a href="<?php echo base_url('Penyakit/delete')."/".$key->id; ?>" class="label label-lg label-danger"onclick="return confirm('Hapus Data Ini ?')">
